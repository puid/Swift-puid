...
final class EntropySource: XCTestCase {
  ...
  func test4bits() throws {
    ...
    let fixedSource = Fixed([
      8_217_508_000_407_054_677, 9_004_388_400_143_975_378,
      1_369_912_841_189_526_514, 14_770_944_148_999_504_823,
    ])
    let entropySource = Puid.Entropy.Source(
      using: fixedSource,
      method: Fixed.method)
  ...
  func test6bits() throws {
    ...
    let generator = Puid.Entropy.Source(
      using: fixedSource,
      method: Fixed.method)
