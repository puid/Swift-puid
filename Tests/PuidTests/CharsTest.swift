...
final class CharsTest: XCTestCase {
  ...
  func testContents() throws {
    ...
    XCTAssert(isAsciiSubset(.base32, of: .uppercaseLetters.union(.decimalDigits).subtracting(CharacterSet(charactersIn: "0189"))))
    XCTAssert(isAsciiSubset(.base32Hex, of: .decimalDigits.union(.lowercaseLetters).subtracting(CharacterSet(charactersIn: "wxyz"))))
    XCTAssert(isAsciiSubset(.base32HexUpper, of: .decimalDigits.union(.uppercaseLetters).subtracting(CharacterSet(charactersIn: "WXYZ"))))
    XCTAssert(isAsciiSubset(.crockford32, of: .decimalDigits.union(.uppercaseLetters).subtracting(CharacterSet(charactersIn: "ILOU"))))
